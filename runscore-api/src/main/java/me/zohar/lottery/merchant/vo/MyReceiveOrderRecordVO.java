...
public class MyReceiveOrderRecordVO {
	...
	public static List<MyReceiveOrderRecordVO> convertFor(List<MerchantOrder> platformOrders) {
	...
	public static MyReceiveOrderRecordVO convertFor(MerchantOrder platformOrder) {
