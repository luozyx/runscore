...
public class MyWaitConfirmOrderVO {
	...
	public static List<MyWaitConfirmOrderVO> convertFor(List<PlatformOrder> platformOrders) {
	...
	public static MyWaitConfirmOrderVO convertFor(PlatformOrder platformOrder) {
